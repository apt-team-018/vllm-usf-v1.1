"""Inference-only Omega17V0_5-VL model compatible with HuggingFace weights."""
...
from transformers.models.qwen2_5_vl import Qwen2_5_VLProcessor as Omega17V0_5_VLProcessor
from transformers.models.qwen2_5_vl.configuration_qwen2_5_vl import (
    Qwen2_5_VLConfig as Omega17V0_5_VLConfig,
    Qwen2_5_VLVisionConfig as Omega17V0_5_VLVisionConfig,
)
...
from .omega17_v0_vl import Omega17V0VLDummyInputsBuilder
from .omega17_v0_vl import (
    Omega17V0VLMultiModalProcessor,
    Omega17V0VLProcessingInfo,
...
class Omega17V0_5_VLImagePixelInputs(TensorSchema):
    """
    Dimensions:
...
class Omega17V0_5_VLImageEmbeddingInputs(TensorSchema):
    """
    Dimensions:
...
Omega17V0_5_VLImageInputs: TypeAlias = (
    Omega17V0_5_VLImagePixelInputs | Omega17V0_5_VLImageEmbeddingInputs
)


class Omega17V0_5_VLVideoPixelInputs(TensorSchema):
    """
    Dimensions:
        - np: Number of patches
        - nv: Number of videos
...
class Omega17V0_5_VLVideoEmbeddingInputs(TensorSchema):
    """
    Dimensions:
...
Omega17V0_5_VLVideoInputs: TypeAlias = (
    Omega17V0_5_VLVideoPixelInputs | Omega17V0_5_VLVideoEmbeddingInputs
)

# === Vision Encoder === #


class Omega17V0_5_VisionMLP(nn.Module):
    def __init__(
        self,
        in_features: int,
        hidden_features: int,
...
class Omega17V0_5_VisionAttention(nn.Module):
    def __init__(
        self,
        embed_dim: int,
        num_heads: int,
...
# )
class Omega17V0_5_VisionBlock(nn.Module):
    def __init__(
        self,
        dim: int,
        num_heads: int,
        ...
        self.attn = Omega17V0_5_VisionAttention(
            embed_dim=dim,
            num_heads=num_heads,
            projection_size=dim,
            quant_config=quant_config,
        ...
        self.mlp = Omega17V0_5_VisionMLP(
            dim,
            mlp_hidden_dim,
            act_fn=act_fn,
            bias=True,
...
class Omega17V0_5_VisionPatchEmbed(nn.Module):
    def __init__(
        self,
        patch_size: int = 14,
...
class Omega17V0_5_VisionPatchMerger(nn.Module):
    def __init__(
        self,
        d_model: int,
        context_dim: int,
...
class Omega17V0_5_VisionRotaryEmbedding(nn.Module):
...
class Omega17V0_5_VisionTransformer(nn.Module):
    def __init__(
        self,
        vision_config: Omega17V0_5_VLVisionConfig,
        norm_eps: float = 1e-6,
        quant_config: QuantizationConfig | None = None,
        prefix: str = "",
        use_data_parallel: bool = False,
        ...
        with set_model_tag("Omega17V0_5_VisionPatchEmbed"):
            self.patch_embed = Omega17V0_5_VisionPatchEmbed(
        ...
        self.rotary_pos_emb = Omega17V0_5_VisionRotaryEmbedding(head_dim // 2)
        ...
        if self.attn_backend not in {
            ...
            raise RuntimeError(
                f"Omega17V0_5-VL does not support {self.attn_backend} backend now."
            )

        with set_model_tag("Omega17V0_5_VisionBlock"):
            self.blocks = nn.ModuleList(
                [
                    Omega17V0_5_VisionBlock(
        ...
        with set_model_tag("Omega17V0_5_VisionPatchMerger"):
            self.merger = Omega17V0_5_VisionPatchMerger(
...
class Omega17V0_5_VLProcessingInfo(Omega17V0VLProcessingInfo):
    def get_hf_config(self):
        return self.ctx.get_hf_config(Omega17V0_5_VLConfig)

    def get_hf_processor(self, **kwargs: object) -> Omega17V0_5_VLProcessor:
        return self.ctx.get_hf_processor(
            Omega17V0_5_VLProcessor,
            use_fast=kwargs.pop("use_fast", True),
            **kwargs,
        )


class Omega17V0_5_VLMultiModalProcessor(Omega17V0VLMultiModalProcessor):
    ...
    def _get_prompt_updates(
        ...
        def get_replacement_omega17v0vl(item_idx: int, modality: str):
        ...
        return [
            PromptReplacement(
                ...
                replacement=partial(get_replacement_omega17v0vl, modality=modality),
            )
...
@MULTIMODAL_REGISTRY.register_processor(
    Omega17V0_5_VLMultiModalProcessor,
    info=Omega17V0_5_VLProcessingInfo,
    dummy_inputs=Omega17V0VLDummyInputsBuilder,
)
class Omega17V0_5_VLForConditionalGeneration(
    nn.Module,
    SupportsMultiModal,
    SupportsLoRA,
    SupportsPP,
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        super().__init__()
        config: Omega17V0_5_VLConfig = vllm_config.model_config.hf_config
        ...
        if multimodal_config.get_limit_per_prompt(
            ...
            self.visual = Omega17V0_5_VisionTransformer(
    ...
    def _parse_and_validate_image_input(
        self, **kwargs: object
    ) -> Omega17V0_5_VLImageInputs | None:
        ...
        if pixel_values is not None:
            return Omega17V0_5_VLImagePixelInputs(
                type="pixel_values",
        ...
        if image_embeds is not None:
            return Omega17V0_5_VLImageEmbeddingInputs(
                type="image_embeds",
    ...
    def _parse_and_validate_video_input(
        self, **kwargs: object
    ) -> Omega17V0_5_VLVideoInputs | None:
        ...
        if pixel_values_videos is not None:
            return Omega17V0_5_VLVideoPixelInputs(
        ...
        if video_embeds is not None:
            return Omega17V0_5_VLVideoEmbeddingInputs(
                type="video_embeds",
    ...
    def _process_image_input(
        self, image_input: Omega17V0_5_VLImageInputs
    ) -> tuple[torch.Tensor, ...]:
    ...
    def _postprocess_image_embeds_evs(
        ...
        image_input: Omega17V0_5_VLImageInputs,
    ) -> tuple[torch.Tensor, ...]:
        """
    ...
    def _process_video_input(
        self, video_input: Omega17V0_5_VLVideoInputs
    ) -> tuple[torch.Tensor, ...]:
    ...
    def _postprocess_video_embeds_evs(
        ...
        video_input: Omega17V0_5_VLVideoInputs,
    ) -> tuple[torch.Tensor, ...]:
        """
    ...
    def forward(
        ...
        **kwargs: object,
        ...
        """Run forward pass for Omega17V0_5-VL.
        ...
        Args:
            ...
            positions: Flattened (concatenated) position ids corresponding to a
                ...
                Omega17V0_5-VL opensource models), the shape will be `(3, seq_len)`,
