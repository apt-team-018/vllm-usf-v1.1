"""Inference-only Omega17VL model compatible with HuggingFace weights."""
...
from transformers.models.qwen2_vl import Qwen2VLImageProcessorFast as Omega17V0VLImageProcessor
...
from .omega17_v0_5_vl import (
    Omega17V0_5_VisionAttention,
    Omega17V0_5_VisionRotaryEmbedding,
    Omega17V0_5_VLImageEmbeddingInputs,
    Omega17V0_5_VLImageInputs,
    Omega17V0_5_VLImagePixelInputs,
    Omega17V0_5_VLVideoEmbeddingInputs,
    Omega17V0_5_VLVideoInputs,
    Omega17V0_5_VLVideoPixelInputs,
)
from .omega17_v0_vl import Omega17V0VLProcessingInfo
from .omega17 import Omega17ForCausalLM, Omega17Model
from .utils import (
    AutoWeightsLoader,
    PPMissingLayer,
    WeightsMapper,
...
class Omega17_VisionTransformer(nn.Module):
    def __init__(
        self,
        vision_config: Omega17VLVisionConfig,
        norm_eps: float = 1e-6,
        quant_config: QuantizationConfig | None = None,
        prefix: str = "",
        use_data_parallel: bool = False,
...
class Omega17VLProcessingInfo(Omega17V0VLProcessingInfo):
    def get_hf_config(self):
        return self.ctx.get_hf_config(Omega17VLConfig)

    def get_hf_processor(self, **kwargs: object) -> Omega17VLProcessor:
    ...
    def get_video_processor(self, **kwargs: object) -> Omega17VLVideoProcessor:
    ...
    def _get_vision_info(
        ...
        *,
        ...
        num_frames: int = 2,
        do_resize: bool = True,
        image_processor: Omega17V0VLImageProcessor | Omega17VLVideoProcessor | None,
    ) -> tuple[ImageSize, int]:
        ...
        is_video = isinstance(image_processor, Omega17VLVideoProcessor)
...
class Omega17VLMultiModalProcessor(BaseMultiModalProcessor[Omega17VLProcessingInfo]):
        ...
        if videos := mm_data.pop("videos", []):
            ...
            for item in videos:
                ...
                if "do_sample_frames" not in video_mm_kwargs:
                    # omega17_vl_utils already has "do_sample_frames" in
    ...
    def _get_prompt_updates(
        ...
        def get_image_replacement_omega17vl(item_idx: int):
        ...
        def get_video_replacement_omega17vl(item_idx: int):
        ...
        return [
            PromptReplacement(
                ...
                replacement=get_image_replacement_omega17vl,
            ),
            ...
            PromptReplacement(
                ...
                replacement=get_video_replacement_omega17vl,
            ),
        ]
...
@support_torch_compile(
    dynamic_arg_dims={
        "input_ids": 0,
        # positions is of shape (3, seq_len) if mrope is enabled for omega17-vl,
        # otherwise (seq_len, ).
        "positions": -1,
...
class Omega17LLMModel(Omega17Model):
...
class Omega17LLMForCausalLM(Omega17ForCausalLM):
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        super(Omega17ForCausalLM, self).__init__()
...
class Omega17VLForConditionalGeneration(
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = "model"):
        super().__init__()
        config: Omega17VLConfig = vllm_config.model_config.hf_config
        quant_config = vllm_config.quant_config
