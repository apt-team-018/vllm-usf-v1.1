"""Inference-only Omega17VLExp model compatible with HuggingFace weights."""
...
from .omega17_vl import (
    Omega17_VisionTransformer,
    Omega17VLDummyInputsBuilder,
    Omega17VLForConditionalGeneration,
    Omega17VLMultiModalProcessor,
    Omega17VLProcessingInfo,
)
...
class Omega17VLExpProcessingInfo(Omega17VLProcessingInfo):
...
class Omega17VLExpForConditionalGeneration(Omega17VLForConditionalGeneration):
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        super(Omega17VLForConditionalGeneration, self).__init__()
