...
@ReasoningParserManager.register_module("omega17")
class Omega17ReasoningParser(BaseThinkingReasoningParser):
    """
    Reasoning parser for the Omega17 model.

    The Omega17 model uses <think>...</think> tokens to denote reasoning text
    ...
    def extract_reasoning_content(
        ...
        Omega17 has stricter requirements - it needs both start and end tokens
