...
_CONFIG_REGISTRY: dict[str, type[PretrainedConfig]] = LazyConfigDict(
    ...
    olmo3="Olmo3Config",
    omega17_vl="Omega17VLConfig",  # Using native config from custom transformers
    omega17_vl_exp="Omega17VLExpConfig",  # Using native config from custom transformers
    omega17_vl_exp_text="Omega17VLExpTextConfig",  # Using native config from custom transformers
    ovis="OvisConfig",
